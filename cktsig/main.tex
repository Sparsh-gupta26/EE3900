...
\solution The ngspice script
\begin{lstlisting}
2_7.cir
\end{lstlisting} 
simulates the given circuit and the generated output is depicted in Fig. \eqref{fig:v1-t}
\end{enumerate}
...
3_5.cir
\end{lstlisting}	
simulates the given circuit and the generated output is depicted in Fig. \eqref{fig:v2-t}.
...
sampling interval. The python code
\begin{lstlisting}
4.7.py
\end{lstlisting}
